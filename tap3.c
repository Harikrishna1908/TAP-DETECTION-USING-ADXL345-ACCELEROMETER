...
#define TAP_INT1_GPIO         14 
#define TAP_INT2_GPIO         26  

// Queue and Timer Handles
QueueHandle_t tap_event_queue;
...
void gpio_init() {
    gpio_config_t io_conf = {
        ...
        .pin_bit_mask = (1ULL << TAP_INT1_GPIO),
    ...
    gpio_isr_handler_add(TAP_INT1_GPIO, tap_isr_handler, (void*)TAP_INT1_GPIO);
}
